                ...
                <figure class="panel-card">
                    ...
                    <div class="panel-card-body">
                        <div class="grid 2xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5">
                            ...
                            {{-- Divider --}}
                            <div class="2xl:col-span-5 lg:col-span-4 md:col-span-2 sm:col-span-1">
                                <h1 class="title mt-3">Referral Code</h1>
                            </div>

                            {{-- Referral Code --}}
                            <div class="input-group">
                                <label for="referral_code" class="input-label">Referral Code <span>(Optional)</span></label>
                                <input type="text" name="referral_code"
                                    value="{{ old('referral_code', request('referral_code')) }}"
                                    id="referral_code"
                                    class="input-box-md @error('referral_code') input-invalid @enderror"
                                    placeholder="Enter Referral Code" minlength="8" maxlength="8">
                                @error('referral_code')
                                    <span class="input-error">{{ $message }}</span>
                                @enderror
                            </div>
